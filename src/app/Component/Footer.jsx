    ...
    <footer className="bg-[#1D1D1D] text-white pt-16 pb-6 px-4">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="text-sm text-gray-400 font-semibold">DEVELOPER
          </span>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-6 text-white mt-8 mb-6">
          {navLinks.map((link, idx) => (
            <a key={idx} href={link.href} className="hover:text-orange-500 transition">
              {link.name}
            </a>
          ))}
        </div>
        ...
        <div className="flex justify-center gap-6 text-xl mb-8">
          <a href="https://www.facebook.com/AjayPaudel666" className="hover:text-orange-500 transition">
            <img src="/facebook.svg" alt="Facebook" />
          </a>
          <a href="https://www.instagram.com/ajaypaudel12/" className="hover:text-orange-500 transition">
            <img src="/instagram.svg" alt="Instagram" />
          </a>
          <a href="https://www.linkedin.com/in/paudelajay/" className="hover:text-orange-500 transition">
